...
- ![Autunite](assets/items/2Autunite.png){ width=64 } **Autunite** — only obtainable from [meteor showers](tips.md#meteor-showers); refines into Plutonium.
- ![Azurite](assets/items/2Azurite.png){ width=64 } **Azurite** — dropped from Large Rocks; refines into Copper.
- ![Celite](assets/items/2Celite.png){ width=64 } **Celite** — dropped from Large Rocks.
- ![Cerussite](assets/items/2Cerussite.png){ width=64 } **Cerussite** — dropped from Large Rocks; refines into Lead.
- ![Corprolite](assets/items/2Corprolite.png){ width=64 } **Corprolite** — dropped by Orcs and Knights; refines into Rust.
- ![Hematite](assets/items/2Hematite.png){ width=64 } **Hematite** — dropped from Large Rocks; refines into Iron.
- ![Smithsonite](assets/items/2Smithsonite.png){ width=64 } **Smithsonite** — dropped from Large Rocks; refines into Zinc.
