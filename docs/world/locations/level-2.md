...
![Level 2 entrance](../../assets/captures/level-2/entrance.png){ width=400 loading=lazy }
...
![Place Holder](../../assets/npcs/aot_placeholder.png){ width=160 loading=lazy }
...
- ![Level 2 viewed from above with Tavern in the distance](../../assets/captures/level-2/view-from-above-with-tavern.png){ loading=lazy data-gallery="level-2" }

    **View from above** - overhead view of Level 2 with the
    [Tavern](tavern.md) visible in the distance.

- ![Start of the Level 2 maze](../../assets/captures/level-2/maze-start.png){ loading=lazy data-gallery="level-2" }

    **Maze start** - the player at the start of the Level 2 maze.

- ![Start of the Level 2 maze with the race start in view](../../assets/captures/level-2/maze-start-with-race.png){ loading=lazy data-gallery="level-2" }

    **Race start** - the green glow on the ground that starts the race when
    you walk through it.

- ![Finish of Level 2 with the Place Holder in view](../../assets/captures/level-2/finish-place-holder.png){ loading=lazy data-gallery="level-2" }

    **Finish room** - the end of the maze with the Place Holder in view.

- ![Finish of Level 2 with the Place Holder directly in view](../../assets/captures/level-2/finish-place-holder-direct.png){ loading=lazy data-gallery="level-2" }
