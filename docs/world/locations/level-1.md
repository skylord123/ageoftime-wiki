...
![Tree entrance to Level 1](../../assets/captures/level-1/level-1-tree-entrance-main.png){ width=400 loading=lazy }
...
- ![Player entering the Level 1 tree from the Woods](../../assets/captures/level-1/tree-entrance-from-woods.png){ loading=lazy data-gallery="level-1" }

    **Tree entrance** - Larry David entering the tree that leads from the
    Woods into Level 1.

- ![Entrance room at the start of Level 1](../../assets/captures/level-1/entrance-room.png){ loading=lazy data-gallery="level-1" }

    **Entrance room** - the first interior space before the maze begins.

- ![Beds in the Level 1 entrance room](../../assets/captures/level-1/entrance-room-beds.png){ loading=lazy data-gallery="level-1" }

    **Entrance beds** - two beds behind the stairs can be used to heal before
    entering the maze.

- ![Player at the start of the Level 1 maze](../../assets/captures/level-1/maze-start.png){ loading=lazy data-gallery="level-1" }

    **Maze start** - the player at the start of the maze before entering the
    combat rooms.

- ![Level 1 race start point](../../assets/captures/level-1/start-race-point.png){ loading=lazy data-gallery="level-1" }

    **Race start** - the green light that starts the Level 1 timed race.

- ![Level 1 room variant wooddungeon7cell](../../assets/captures/level-1/room-variant-wooddungeon7cell.png){ loading=lazy data-gallery="level-1" }

    **Room variant** - `wooddungeon7cell`, one of the room layouts used in
    the maze.

- ![Level 1 room variant wooddungeonInt1](../../assets/captures/level-1/room-variant-wooddungeonint1.png){ loading=lazy data-gallery="level-1" }

    **Room variant** - `wooddungeonInt1`, one of the room layouts used in the
    maze.

- ![Level 1 room variant wooddungeonInt2](../../assets/captures/level-1/room-variant-wooddungeonint2.png){ loading=lazy data-gallery="level-1" }

    **Room variant** - `wooddungeonInt2`, one of the room layouts used in the
    maze.

- ![Level 1 room variant wooddungeonInt4](../../assets/captures/level-1/room-variant-wooddungeonint4.png){ loading=lazy data-gallery="level-1" }

    **Room variant** - `wooddungeonInt4`, one of the room layouts used in the
    maze.

- ![Maze finish point with the Hook in the center](../../assets/captures/level-1/maze-finish-point.png){ loading=lazy data-gallery="level-1" }

    **Maze finish** - the Hook in the center of the end room, with the race
    finish point visible near the bottom center.

- ![Player about to pick up the Hook for the first time](../../assets/captures/level-1/end-reward-room-first-hook.png){ loading=lazy data-gallery="level-1" }

    **Hook pickup** - the end reward room with a player about to collect the
    Hook for the first time.

- ![Close-up of the Hook reward in the end room](../../assets/captures/level-1/hook-reward-closeup.png){ loading=lazy data-gallery="level-1" }
